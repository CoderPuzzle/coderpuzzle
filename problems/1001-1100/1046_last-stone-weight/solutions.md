...
![On stones = [2,7,4,1,8,1], the max-heap pops 8 and 7, then 4 and 2, then 2 and 1, pushing each difference back, before 1 and 1 annihilate and leave the single stone 1.](figures/solution-max-heap-turns.svg)
