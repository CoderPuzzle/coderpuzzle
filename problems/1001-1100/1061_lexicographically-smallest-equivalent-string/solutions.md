...
![Unioning the pairs of s1 = "parker" and s2 = "morris" with the larger root attached under the smaller leaves four components rooted at their smallest letters — {m,p}, {a,o}, {k,r,s}, {e,i} — so parser maps to makkek.](figures/solution-union-find-smallest-root.svg)
