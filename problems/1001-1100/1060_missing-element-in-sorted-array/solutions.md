...
![For nums = [4,7,9,10] and k = 1 the missing counts are 0, 2, 3, 3; the
binary search settles on lo = 1 and returns nums[0] + (1 − 0) = 5, the first
missing value on the number line.](figures/solution-missing-count-bsearch.svg)
