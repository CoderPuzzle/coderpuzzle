...
![On head = [2, 1, 5] the stack holds indices 0 and 1 (values 2, 1) until value 5 arrives, pops both, and writes 5, 5 into the answer while the final slot keeps its 0.](figures/solution-monotonic-stack-indices.svg)
