...
![On Example 3's graph with labels b, b, a, c, the bitmask DP seeds at centre node 3 ("c") and appends the matching b-pair, nodes 0 and 1, reaching mask {0, 1, 3} that spells the palindrome "bcb" of length 3.](figures/solution-palindrome-endpoint-expansion.svg)
