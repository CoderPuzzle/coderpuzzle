...
![On Example 2 (n = 7, edges [[0,2],[0,5],[2,4],[1,6],[5,4]]), union by size grows components of sizes 4, 2 and 1, and C(7,2) − (6 + 1 + 0) = 14 unreachable pairs.](figures/solution-union-find-sizes.svg)
