...
![With n = 6, delay = 2, forget = 4 the cohort bars are know = [1,0,1,1,1,2]; day 6's new learners are the window sum know[3] + know[4] = 2, and the aware total is know[3..6] = 5.](figures/solution-know-sliding-window.svg)
