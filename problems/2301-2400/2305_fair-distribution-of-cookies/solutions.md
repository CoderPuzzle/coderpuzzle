...
On cookies = [8,15,10,20,8] with k = 2, the backtracking tree assigns bags level by level, the bound and symmetry prunes gray out the dead branches, and the surviving best leaf splits 31 and 30.

![On cookies = [8,15,10,20,8] with k = 2, the backtracking tree assigns bags level by level, the bound and symmetry prunes gray out the dead branches, and the surviving best leaf splits 31 and 30.](figures/solution-backtrack-bound-symmetry-tree.svg)
