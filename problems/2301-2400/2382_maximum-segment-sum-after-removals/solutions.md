...
![On nums = [1,2,5,6,1] with removeQueries = [0,3,2,4,1], activating 1, 4, 2, 3 in reverse merges segments of sums 2, 2, 7, 14, so the records [0, 2, 2, 7, 14] reversed give the answers [14, 7, 2, 2, 0].](figures/solution-reverse-activation-union-find.svg)
