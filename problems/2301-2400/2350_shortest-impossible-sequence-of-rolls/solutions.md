...
![On rolls = [4,2,1,2,3,3,2,4,1] with k = 4, the scan brackets two maximal windows that each contain all four faces — {4,2,1,3} and {3,2,4,1} — so the answer is windows + 1 = 3.](figures/solution-two-complete-windows.svg)
