...
![On the Example 1 sheet (m = 3, n = 5), the dp table fills in increasing height and width, and a winning horizontal cut after row 1 gives dp[1][5] + dp[2][5] = 2 + 17 = 19.](figures/solution-dp-table-cuts.svg)
