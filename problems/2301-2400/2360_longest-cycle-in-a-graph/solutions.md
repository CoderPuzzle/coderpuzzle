...
![Walking edges = [3,3,4,2,3] from node 0 stamps t=0..3 on nodes 0, 3, 2, 4 and the next step lands on 3, still color 1, so the cycle closes with timer − step[3] = 4 − 1 = 3.](figures/solution-timer-step-cycle.svg)
