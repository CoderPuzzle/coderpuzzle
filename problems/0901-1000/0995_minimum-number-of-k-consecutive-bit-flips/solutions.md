...
![On nums = [0,0,0,1,0,1,1,0] with k = 3, the running parity flip and the effective bits it produces force flips exactly at i = 0, 4, 5, whose three windows leave every bit 1.](figures/solution-greedy-flip-parity.svg)
