...
![Sliding the window over TTFTTFTT with k = 1, each row shows the live window and its counts; adding the second F makes the minority 2 > 1 and triggers the single shrink of l from 0 to 3, and the two length-5 windows TTFTT (indices 0-4 and 3-7) give the answer 5.](figures/solution-minority-window-steps.svg)
