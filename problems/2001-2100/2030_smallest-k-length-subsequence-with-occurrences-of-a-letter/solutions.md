...
![On s = leet with k = 3 and letter e, the stack fills to eet: the only pop is 'l' at i = 1, where 3 characters remain for k = 3 and the e-supply stays 1 + 1 = 2 ≥ repetition 1.](figures/solution-monotonic-stack-pop-guard.svg)
