...
![On nums = [1,2,1], the doubled scan i = 0..5 shows the first 2 popping idx 0 (result[0] = 2) and the second lap's 2 resolving the waiting idx 2 (result[2] = 2), while the 2 itself keeps -1.](figures/solution-circular-monotonic-stack.svg)
