...
![On n = 5 (bits 101), each 1 bit contributes the strings formed by placing a 0 there — fib[2] = 3 then fib[0] = 1 — and n itself adds 1, so the count is 5.](figures/solution-fib-bit-scan.svg)
