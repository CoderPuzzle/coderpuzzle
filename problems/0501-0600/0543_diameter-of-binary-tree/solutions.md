...
![On the tree [1,2,3,4,5], the post-order walk returns heights 1, 1, 2, 1 and records candidates 0, 2, 0 on the way up, and the root's 2 + 1 = 3 — the path 4-2-1-3 — is the largest, so the diameter is 3.](figures/solution-post-order-height-candidates.svg)
