...
![On s = "abcdeca", the table fills shortest intervals first; the matched ends c..c and a..a lift dp[0][6] to LPS 5, and n − 5 = 2 ≤ k = 2 makes the string a 2-palindrome.](figures/solution-interval-dp-lps.svg)
