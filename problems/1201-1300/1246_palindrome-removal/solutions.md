...
![For arr = [1, 3, 4, 1, 5] the interval table fills by increasing length, and the equal-end 1...1 interval takes dp[0][3] = dp[1][2] = 2, so the final split gives dp[0][4] = dp[0][3] + dp[4][4] = 2 + 1 = 3.](figures/solution-interval-dp-table.svg)
