...
![On s = "deeedbbcccbdaa" with k = 3, each arriving run that reaches length 3 pops — eee, ccc, bbb, then ddd — leaving the stack [a ×2], which expands to "aa".](figures/solution-run-length-stack-cascade.svg)
