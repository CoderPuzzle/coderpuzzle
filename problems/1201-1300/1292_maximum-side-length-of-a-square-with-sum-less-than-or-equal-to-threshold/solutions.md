...
![On the 3 x 7 mat of example 1 with threshold 4, corner (0,0) reads its square sum from the (m+1) x (n+1) prefix table — side 2 sums to exactly 4, side 3 to 15 — so ans grows to 2 and stops.](figures/solution-prefix-growing-square.svg)
