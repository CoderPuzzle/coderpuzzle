...
![On the z = 5 grid (excerpt x, y <= 5) the corner walk starts at (1, 5), sees f = 6 > 5 and drops that column, then records the four anti-diagonal hits [1,4], [2,3], [3,2], [4,1].](figures/solution-corner-walk.svg)
