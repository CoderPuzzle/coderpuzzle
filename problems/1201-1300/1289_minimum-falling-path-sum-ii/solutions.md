...
![On grid [[1,2,3],[4,5,6],[7,8,9]] the dp rows fill from the previous row's min1 — cells in idx1's column take the m2 fallback — so the winning path 1, 5, 7 ends at dp 13.](figures/solution-two-min-dp-rows.svg)
