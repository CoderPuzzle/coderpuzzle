...
![Scanning i = 2 … 9 for n = 10, the spf writes land exactly once each — 4 by
i=2·p=2, 6 by i=3·p=2, 9 by i=3·p=3, 8 by i=4·p=2 — the inner loop stops past
spf[i], and the self-written 2, 3, 5, 7 are the 4 primes.](figures/solution-linear-sieve-spf-writes.svg)
