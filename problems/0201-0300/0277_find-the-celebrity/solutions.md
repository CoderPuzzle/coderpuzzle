...
![On graph [[1,1,0],[0,1,0],[1,1,1]] the pass drops 0 (0 knows 1) and then 2 (candidate 1 does not know 2), leaving candidate 1, which row 1 = [0,1,0] and column 1 = [1,1,1] then verify.](figures/solution-elimination-then-verify.svg)
