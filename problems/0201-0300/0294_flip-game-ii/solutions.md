...
![From "++++" the flips at spots 0-1 and 2-3 lead to "--++" and "++--", where the opponent wins, while the middle flip to "+--+" leaves the opponent no move — canWin("++++") is true, and the run multisets {4} → {2}, {}, {2} collapse to one successor pair.](figures/solution-flip-game-tree.svg)
