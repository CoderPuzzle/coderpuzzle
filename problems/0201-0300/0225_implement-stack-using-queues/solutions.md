...
![Pushing 1 then 2 into one queue: 2 enters at the back of [1, 2] and the rotation moves 1 behind it, so the front 2 is the stack top.](figures/solution-rotate-on-push.svg)
