...
![Probing the statement's tree [1,2,3,4,5,6]: the root's spines measure 3 against 2, the subtree at 2 settles as a perfect 2^2 - 1 = 3, and only 3's ragged side recurses, totaling 1 + 3 + 2 = 6.](figures/solution-height-probe-recursion.svg)
