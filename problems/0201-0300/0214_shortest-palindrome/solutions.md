...
![Running the prefix function over abcd#dcba leaves last entry 1 — the longest palindromic prefix a — so the reverse of the remaining bcd is prepended to form dcbabcd.](figures/solution-kmp-lps-last-entry.svg)
