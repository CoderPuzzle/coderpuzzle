...
![On [3,2,3] the two slots adopt 3 and 2, the second 3 raises its slot's counter to 2, and the verify pass keeps only 3 because 2 occurs once, not more than ⌊3/3⌋ = 1.](figures/solution-boyer-moore-two-slots.svg)
