...
![In the tree [1, null, 3, 2, 4, null, null, null, 5] each node carries the length of the run ending there, and the accented 3-4-5 path reaches the maximum 3.](figures/solution-run-length-per-node.svg)
