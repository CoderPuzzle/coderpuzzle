...
![Scanning 3+2*2, the term stack takes 3, then 2 beside it, and the final 2 combines under * into 4 on top, leaving the stack to sum to 3 + 4 = 7.](figures/solution-term-stack.svg)
