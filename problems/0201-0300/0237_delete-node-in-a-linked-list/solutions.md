...
![On Example 1's list 4 → 5 → 1 → 9 with node = 5, node 5 copies in the successor's value 1 and its next skips past the old 1, leaving 4 → 1 → 9.](figures/solution-copy-successor-bypass.svg)
