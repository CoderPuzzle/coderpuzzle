...
![On Example 1's "2-1-1", the recursion tree lets each '-' take its turn as the root split, yielding 2 - (1 - 1) = 2 and (2 - 1) - 1 = 0, which sorted ascending give [0, 2].](figures/solution-operator-recursion-tree.svg)
