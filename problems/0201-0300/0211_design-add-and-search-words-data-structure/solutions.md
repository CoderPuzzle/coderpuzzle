...
![Adding bad, dad and mad builds three parallel a-d spines off the root; the query .ad branches over all three first letters and ends at every end flag, while pad dies at the root's missing p child.](figures/solution-dot-branch-trie.svg)
