...
![Inverting 4(2(1,3),7(6,9)) swaps each node's two finished subtrees — 4's (2,7), 2's (1,3), 7's (6,9) — yielding the mirror 4(7(9,6),2(3,1)).](figures/solution-recursive-swap.svg)
