...
![The example meetings [0, 30], [5, 10], [15, 20] sorted by start drive the min-heap of end times from {30} to {10, 30} to {20, 30} — 5 opens a new room while 30 still runs, 15 reuses the room ending at 10, and the peak heap size 2 is the room count.](figures/solution-min-heap-end-times.svg)
