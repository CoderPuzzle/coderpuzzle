...
![On 1-2-2-1 the slow/fast sweep stops with slow at the third node, the back half 2-1 reversed in place reads 1-2, and the lockstep comparison matches 1 = 1 and 2 = 2, so the list is a palindrome.](figures/solution-reverse-second-half.svg)
