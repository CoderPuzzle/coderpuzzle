...
![After push(1) and push(2) the in stack holds 2 over 1; the first peek finds the out stack empty, pours both across, and the oldest value 1 ends up on top, so peek returns 1.](figures/solution-lazy-transfer.svg)
