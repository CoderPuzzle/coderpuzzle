...
![Sweeping Example 1's six trees, Welzl rebuilds on every escape — the (2,4) escape finally pins the diameter (2,0)-(2,4) circle at center (2, 2) with radius 2.](figures/solution-welzl-incremental-circle.svg)
