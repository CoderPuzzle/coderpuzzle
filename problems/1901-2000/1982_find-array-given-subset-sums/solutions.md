...
![On the sorted sums [-3,-2,-1,0,0,1,2,3] each round pairs s with s + diff and keeps the half containing 0, peeling +1, +2, then -3 down to the empty subset [0].](figures/solution-greedy-pairing-peel.svg)
