...
![Example 1's timeline with the two heaps right after t = 2: occupied holds (3, chair 1) and (4, chair 0) while free is empty, so friend 1 takes the new chair 1 — the answer — and the (3, chair 1) entry pops into free at the first arrival t >= 3, handing chair 1 back before friend 2 is seated at t = 4.](figures/solution-two-heap-timeline.svg)
