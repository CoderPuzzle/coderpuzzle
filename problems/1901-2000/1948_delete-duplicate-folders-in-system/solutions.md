...
![In example 1's trie, the post-order signatures give /a and /c the same id — each holds a single leaf b — so the count-2 signature marks both subtrees for deletion and only /d and /d/a survive.](figures/solution-subtree-signature-dedup.svg)
