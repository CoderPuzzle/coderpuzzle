...
![On points = [2,4] with m = 3, the check for target 4 bounces twice at index 0 for 2·2 − 1 = 3 moves and covers index 1's quota with the banked visit, while target 5 already needs 2·3 − 1 = 5 moves at index 0, so binary search returns 4.](figures/solution-bounce-feasibility-check.svg)
