...
![On s = "abced" with k = 2, matching the ends b and d of s[1..4] costs cyclic distance 2, so dp[1][4][2] = dp[2][3][0] + 2 = 3 — the palindrome ccc.](figures/solution-interval-dp-match-ends.svg)
