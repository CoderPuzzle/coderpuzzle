...
![On example 1, the four corners of the side-2 square unroll to perimeter coordinates 0, 2, 4, 6 on the circle of circumference 8, where greedy hops keep every arc gap at d = 2.](figures/solution-perimeter-circle-greedy.svg)
