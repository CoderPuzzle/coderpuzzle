...
![On squares = [[0,0,1],[2,2,1]] the sweep applies events at y = 0, 1, 2 and holds union widths 1, 0, 1 across the bands, so the running area first reaches half of the total 2 at the top of band (0, 1), giving y = 1.00000.](figures/solution-y-sweep-band-areas.svg)
