...
![On prices [3,3,5,0,0,3,1,4] the four-state wealth table fills day by day, the second buy firing at price 0 (buy2 = 2 - 0 = 2) and sales at 3 then 4 lifting sell2 to 5 and finally the answer 6.](figures/solution-state-machine-wealth-table.svg)
