...
![The prefix table on 'catsanddog': dp[3] = [cat], dp[4] = [cats], dp[7] = [cats and, cat sand] with the shorter last word landing first, and both dp[7] sentences take dog to fill dp[10].](figures/solution-dp-sentence-table.svg)
