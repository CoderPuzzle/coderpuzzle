...
![With targetSum 22 over the example tree, the stack pairs carry remaining sums that shrink 22 to 17 to 13 to 2 down the path 5-4-11; leaf 7 pops short at 7 ≠ 2, and leaf 2 then comes off the stack covering exactly what is still owed, 2 = 2, so the answer is true.](figures/solution-remaining-stack.svg)
