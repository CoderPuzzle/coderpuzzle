...
![On `[2,7,11,15]` with target 9 the pointers converge from the ends —
`2 + 15 = 17` and `2 + 11 = 13` both retire the right endpoint — until
`2 + 7 = 9` lands on the answer `[1,2]`.](figures/solution-converging-two-pointers.svg)
