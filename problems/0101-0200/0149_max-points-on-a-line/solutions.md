...
![With anchor (3, 2) in example 2, the directions to (4, 1), (2, 3), and (1, 4) all reduce to (1, -1), so 1 + 3 = 4 points lie on the slope -1 line.](figures/solution-anchor-slope-buckets.svg)
