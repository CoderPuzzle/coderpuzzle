...
![On nums = [3, 4, 5, 1, 2], step 1 sees nums[mid] = 5 > nums[hi] = 2 and sends lo right of mid; step 2 sees 1 ≤ 2 and collapses hi onto mid, so lo and hi meet on the drop and return 1.](figures/solution-binary-search-right-end.svg)
