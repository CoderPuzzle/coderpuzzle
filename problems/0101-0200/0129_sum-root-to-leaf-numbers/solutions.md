...
![On tree [4,9,0,5,1] the stack of (node, prefix) pairs carries 4 into 49 and then 495 down the accented path, and only the leaf pops sum: 495 + 491 + 40 = 1026.](figures/solution-path-number-stack.svg)
