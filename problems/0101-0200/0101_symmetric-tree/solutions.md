...
![For root = [1, 2, 2, 3, 4, 4, 3], the mirror axis pairs each left-subtree node with its opposite: outer 3 = 3 and inner 4 = 4 across the dashed axis, so the tree is symmetric.](figures/solution-mirror-axis-pairs.svg)
