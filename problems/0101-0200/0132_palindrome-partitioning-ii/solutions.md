...
![On s = aab the aa center drops cut[2] to cut[0] + 1 = 0, after which center (2,2) sets cut[3] = cut[2] + 1 = 1 — the one cut that [aa, b] needs.](figures/solution-cut-center-expansion.svg)
