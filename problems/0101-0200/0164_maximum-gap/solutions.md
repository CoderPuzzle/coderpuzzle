...
![On `[3,6,9,1]` the span 1–9 is cut into three width-3 buckets keeping only
each bucket's min and max, and the sweep measures only the boundary jumps
`6 − 3 = 3` and `9 − 6 = 3` for the answer 3.](figures/solution-bucket-boundary-jumps.svg)
