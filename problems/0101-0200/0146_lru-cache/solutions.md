...
![On example 1's capacity-2 cache, get(1) relinks node 1 at the MRU end, put(3, 3) evicts LRU node 2, and put(4, 4) evicts node 1, leaving {3 = 3, 4 = 4}.](figures/solution-lru-recency-list-evictions.svg)
