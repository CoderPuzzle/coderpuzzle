...
![Seeded with [1,1,1,1], the single array folds right-to-left through [1,2,1,1] and the mid-pass state [1,2,3,1] to [1,3,3,1], each update reading its left neighbor before that neighbor is clobbered.](figures/solution-inplace-row-fold.svg)
