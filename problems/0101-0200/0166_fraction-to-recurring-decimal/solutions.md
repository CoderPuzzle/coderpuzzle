...
![For `4/333` the remainders 4, 40, 67 flow into the remainder-to-position map,
and remainder 4 arriving a second time opens the parentheses at its recorded
position 0 for `0.(012)`.](figures/solution-remainder-map-cycle.svg)
