...
![Reading s = eceba, the window grows to ece with map e:2, c:1 and best 3; each later third letter advances the left end, draining c to 0 and then e, so width 3 is never beaten.](figures/solution-window-count-map.svg)
