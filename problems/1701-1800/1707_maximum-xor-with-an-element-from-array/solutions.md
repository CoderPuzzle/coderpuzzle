...
![With the sorted insert pointer admitting only 0 and 1 for m = 1, the trie descent for x = 3 prefers the complement bit at bits 1 and 0, lands on 0, and scores 0 XOR 3 = 3.](figures/solution-offline-trie-descent.svg)
