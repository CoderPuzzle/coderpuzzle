...
![On sorted coins [1, 3], coin 1 satisfies 1 ≤ 0 + 1 and lifts the reachable range from [0, 0] to [0, 1], but coin 3 exceeds 1 + 1 and stops the scan with value 2 unmakeable — the answer is reachable + 1 = 2.](figures/solution-greedy-reachable-interval.svg)
