...
![On cars = [[1,2],[2,1],[4,3],[7,2]], the right-to-left scan pushes car 3, computes t = 3 for car 2, empties the stack popping the faster cars 2 and 3 at step i = 1, and computes t = 1 for car 0 — answer [1, -1, 3, -1].](figures/solution-fleet-leader-stack.svg)
