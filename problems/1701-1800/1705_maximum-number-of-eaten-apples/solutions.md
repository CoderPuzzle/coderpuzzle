...
![On apples [1,2,3,5,2] with days [3,2,1,4,2], each bar spans a batch's fresh days with its eaten apples dotted and rotting counts badged, and the strip names the earliest-rotting supplier of each of the 7 apples eaten.](figures/solution-eat-soonest-rot-batches.svg)
