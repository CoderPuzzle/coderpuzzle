...
![On start = [6,0,3], d = 2, the sorted intervals [0,2], [3,5], [6,8] take the greedy leftmost points 0, 4, 8 spaced exactly x = 4 apart, while the check at x = 5 dies at 10 outside [6,8] — the answer is 4.](figures/solution-greedy-leftmost-points.svg)
