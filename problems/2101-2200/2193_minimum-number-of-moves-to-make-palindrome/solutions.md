...
![On s = letelt the greedy matches each outer pair by bubbling the inner partner one step right — the l once, then the e — so letelt becomes the palindrome lettel in 2 swaps.](figures/solution-greedy-outer-pair-bubble.svg)
