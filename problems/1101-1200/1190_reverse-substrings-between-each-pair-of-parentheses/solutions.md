...
![On Example 2's `(u(love)i)`, the stack grows to `["", "u", "love"]`, the inner `)` pops and reverses `love` into the `uevol` of `["", "uevol"]`, and the outer `)` finally flips `uevoli` to `iloveu`.](figures/solution-fragment-stack-reversal.svg)
