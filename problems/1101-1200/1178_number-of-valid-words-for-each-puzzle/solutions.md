...
![For puzzle "aboveyz" only "aaaa" has a distinct-letter mask, {a}, that is a submask of {a, b, o, v, e, y, z} containing the first letter, so its count contributes 1.](figures/solution-word-mask-submask-check.svg)
