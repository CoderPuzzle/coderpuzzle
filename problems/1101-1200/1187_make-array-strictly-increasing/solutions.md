...
![Scanning arr1 = [1, 5, 3, 6, 7] with arr2 sorted to [1, 2, 3, 4], the frontier of (last value, min ops) states funnels through the replace-5-with-2 fork — the (5, 0) state dies at i = 2 — reaching (7, 1) at a cost of 1.](figures/solution-dp-frontier-last-value.svg)
