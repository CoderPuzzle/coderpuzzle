...
![Sliding a window of length ones = 3 over [1, 0, 1, 0, 1] gives zero counts 1, 2, 1; the minimum of 1 is the number of swaps needed to group all the 1s.](figures/solution-sliding-window-zero-count.svg)
