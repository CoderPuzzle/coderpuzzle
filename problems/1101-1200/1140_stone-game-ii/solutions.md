...
![For piles [2,7,9,4,4] the table fills right to left until dp[0][1] = max(18 − 8, 18 − 17) = 10: Alice takes one pile, Bob two, Alice the last two.](figures/solution-dp-suffix-m-table.svg)
