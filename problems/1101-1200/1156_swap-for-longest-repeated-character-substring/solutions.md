...
![On ababa, the run-length encoding a·1 b·1 a·1 b·1 a·1 with counts a = 3, b = 2 lets the two a-runs glue across a separator b for 1 + 1 + 1 = 3 — the answer.](figures/solution-rle-separator-merge.svg)
