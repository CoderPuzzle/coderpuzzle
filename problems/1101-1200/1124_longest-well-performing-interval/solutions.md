...
![For hours = [9,9,6,0,6,6,9] the prefix step line makes p positive through day 2, so best = 3 for [9,9,6]; day 6's lookup first[-2] = 5 adds only length 1.](figures/solution-prefix-first-occurrence.svg)
