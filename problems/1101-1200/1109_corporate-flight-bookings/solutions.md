...
![On bookings = [[1,2,10],[2,3,20],[2,5,25]] with n = 5, the three bookings stamp +seats/−seats into a six-slot diff array, and the running sweep accumulates the answer [10,55,45,25,25].](figures/solution-delta-stamps-prefix-sum.svg)
