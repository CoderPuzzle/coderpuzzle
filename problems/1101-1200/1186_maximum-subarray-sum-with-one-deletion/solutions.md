...
![Scanning arr = [1, -2, 0, 3], one_del branches from the previous no_del = 1 exactly at -2 (deleting it), then rides 1 + 0 and 1 + 3 = 4 to the answer best = 4.](figures/solution-kadane-one-deletion-states.svg)
