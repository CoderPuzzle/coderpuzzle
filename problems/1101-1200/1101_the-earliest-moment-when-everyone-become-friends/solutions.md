...
![Replaying Example 1's sorted logs, the six singleton components fuse 6 → 5 → 4 → 3 → 2 → 1 (the 20190224 pair is already connected), so the 20190301 union of 0 and 3 is the answer.](figures/solution-union-find-timeline.svg)
