...
![With parent = [-1, 0, 0, 1, 1, 2, 2], the rows up[j][v] store jumps of 1, 2 and 4; getKthAncestor(6, 3) reads 3 = 2 + 1 as a lift of 6 to 0 and then past the root to -1, while getKthAncestor(5, 2) rides one 2-jump to 0.](figures/solution-binary-lifting-jumps.svg)
