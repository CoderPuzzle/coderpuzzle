...
![On arr = [2, 3, 1, 6, 7], the prefix xor row repeats 0 (positions -1 and 2) and 1 (positions 1 and 4); each arc spans 3 positions and adds 2 triplets, for the total 4.](figures/solution-prefix-xor-arcs.svg)
