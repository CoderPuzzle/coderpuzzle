...
![On abciiidef with k = 3 each slide applies the enter and leave deltas to the running count, which climbs from 1 to 3 on the window iii — the answer.](figures/solution-sliding-vowel-window.svg)
