...
![Sweeping prices = [8, 4, 6, 2, 3] left to right, each column shows the strictly increasing stack of pending indices after that arrival pops every item it discounts, and the never-popped items keep the answer [4, 2, 4, 2, 3].](figures/solution-pending-discount-stack.svg)
