...
![On nums = [2,3,6], index 0 claims prime 2 and index 1 claims prime 3, so index 2 (value 6) unions with last[2]=0 and last[3]=1, chaining all three indices into one component.](figures/solution-prime-hub-unions.svg)
