...
![On nums = [2,3,7,9,3] the right-to-left pile starts at 3, restarts fresh at 9 because 9 > 3, then absorbs 7, 3, 2 as each stays at most the pile, building 9+7+3+2 = 21 — the largest pile seen, and the answer.](figures/solution-right-to-left-pile.svg)
