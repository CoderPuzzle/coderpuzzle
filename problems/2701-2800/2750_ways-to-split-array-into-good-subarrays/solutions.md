...
![On nums = [0, 1, 0, 0, 1], the 1s at indices 1 and 4 force exactly one cut into the 2-zero gap, and its 2 + 1 = 3 slots are the whole product, so the answer is 3.](figures/solution-gap-cut-slots.svg)
