...
![On nums = [-2,0,2] with s = RLL and d = 3 the two colliding bodies pass through each other on the number line, and the sorted positions [-3,-1,1] pair by prefix sums to 2 + 4 + 2 = 8.](figures/solution-pass-through-prefix-sums.svg)
