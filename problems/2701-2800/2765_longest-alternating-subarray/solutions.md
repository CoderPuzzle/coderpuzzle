...
![On nums = [2,3,4,3,4], the run [2,3] breaks at index 2 where +1 arrives but -1 is expected; since the actual difference is itself +1, the scan restarts at the previous pair (3,4) with cur = 2, and cur then grows 3, 4 into the winning [3,4,3,4] — the answer 4.](figures/solution-restart-previous-pair.svg)
