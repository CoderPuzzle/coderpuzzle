...
![On s = "mbadm" the table fills by increasing interval length, charging 1 for each mismatched outer pair, and the free outer m…m pair gives dp[0][4] = dp[1][3] = 2 insertions.](figures/solution-interval-dp-table.svg)
