...
![On the example 1 classroom, rows 0 and 2 take admissible mask 010010 while every row 1 mask except the empty one collides diagonally, seating 2 + 0 + 2 = 4 students.](figures/solution-row-mask-dp.svg)
