...
![Reversing target = [9,3,5] with a max-heap replaces the largest with largest minus rest - 9-8, 5-4, 3-2 - unwinding every element to 1, so the answer is true.](figures/solution-reverse-max-heap.svg)
