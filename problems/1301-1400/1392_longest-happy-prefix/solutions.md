...
![Scanning "level" left to right builds pi = [0, 0, 0, 0, 1]: every mismatch arrives with j already 0, only the final l extends a match, and the surviving border of length pi[4] = 1 is the answer "l".](figures/solution-kmp-prefix-function.svg)
