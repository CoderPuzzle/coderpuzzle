...
![With Example 1's engineers sorted by decreasing efficiency 9, 7, 5, 4, 3, 2, the min-heap keeps the fastest speeds and `speed_sum` follows; the step capped by efficiency 4 holds speeds 10 and 5 and scores (10 + 5) × 4 = 60, the sweep's maximum.](figures/solution-efficiency-sweep-heap.svg)
