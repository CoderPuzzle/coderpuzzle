...
![On example 2's tree, raising edge (1,3) from 4 to 7 adds +3 over node 3's Euler interval [3..3] and −3 at tout+1 = 4, so dist(3) = base 4 + 3 = 7 while dist(2) = 2 + 0 = 2.](figures/solution-euler-fenwick-range-add.svg)
