...
![For r = 28, the base-8 digits [3, 4] branch four ways at pos 0 — not-started 8, started free 7 and 6, tight 2 — so count(28) = 8+7+6+2 = 23, count(22) = 20, and the difference 3 is exactly base-8 27, 33 and 34.](figures/solution-digit-dp-tight-free.svg)
