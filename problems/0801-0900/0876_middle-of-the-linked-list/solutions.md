...
![On head [1, 2, 3, 4, 5], fast stops on node 5 with its next link missing after two double-strides, leaving slow — at half the links — standing on the middle node 3.](figures/solution-fast-slow-middle.svg)
