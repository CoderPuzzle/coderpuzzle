...
![On s = "leet2code3" with k = 10, the forward tape lengths run 4, 8, 12, 36, and the backward pass folds k to (10 − 1) % 12 + 1 = 10 inside the 12-letter block, where it stops at 'o' — the 10th letter of the tape.](figures/solution-tape-length-backward-fold.svg)
