...
![Rolling keep/swap across nums1 = [1,3,5,4] and nums2 = [1,2,3,7], the natural license holds through i = 2 and only the crossed flip survives at i = 3, landing on keep = 2, swap = 1 for min = 1.](figures/solution-keep-swap-roll.svg)
