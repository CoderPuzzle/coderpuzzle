...
![Seeding a multi-source BFS at every node, the walk 1 → 0 → 2 → 0 → 3 fills the visited mask 0010, 0011, 0111, 0111, 1111 — the revisit adds no bit — and the first full-mask state (3, 1111) pops at distance 4, the answer.](figures/solution-mask-fills-along-walk.svg)
