...
![For k = 2, n = 6, the recurrence dp[m][e] = dp[m - 1][e - 1] + dp[m - 1][e] + 1 fills the moves-by-eggs table; dp[3][2] = 2 + 3 + 1 = 6 is the first entry to reach 6 floors, so 3 moves suffice.](figures/solution-floors-per-move-dp.svg)
