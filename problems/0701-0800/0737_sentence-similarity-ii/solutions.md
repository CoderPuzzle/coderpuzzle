...
![Unioning Example 2's four pairs in order leaves one component rooted at onepiece, so find(leetcode) = find(onepiece) and the aligned pair is similar while I and love match as identical words.](figures/solution-union-find-chain.svg)
