...
![On nums1 = [1,2,3,2,1] against nums2 = [3,2,1,4,7], the suffix-dp grid fills bottom-up and the matched diagonal dp[4][2] = 1, dp[3][1] = 2, dp[2][0] = 3 marks the repeated subarray [3,2,1], the maximum.](figures/solution-suffix-dp-diagonal.svg)
