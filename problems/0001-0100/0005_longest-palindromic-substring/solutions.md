...
![On s = "babad", the nine centers sit under the string: the odd center at index 1 expands 'a' once to 'bab' (length 3) while all four even gaps fail their first comparison, and the later tie 'aba' never replaces the leftmost answer.](figures/solution-expand-centers.svg)
