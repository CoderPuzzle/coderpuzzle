...
![10 ÷ 3 as chunked subtraction: the divisor doubles to the chunk 6 (quotient += 2), the chunk resets to 3 against the remaining 4 (quotient += 1), and the remainder 1 can hold no more — the quotient is 2 + 1 = 3 after two subtractions.](figures/solution-chunk-doubling.svg)
