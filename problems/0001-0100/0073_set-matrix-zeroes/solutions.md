...
![On [[1,1,1],[1,0,1],[1,1,1]] the centre 0 stamps markers at (1,0) and (0,1), the sweeps zero row 1 and column 1, and both saved flags read false, so row 0 and column 0 survive untouched.](figures/solution-marker-row-column-sweeps.svg)
