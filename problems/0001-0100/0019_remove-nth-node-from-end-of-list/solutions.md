...
![On [1,2,3,4,5] with n = 2: fast starts two nodes ahead of slow at the dummy, the lockstep walk leaves slow on node 3 — the predecessor — and slow.next = slow.next.next drops 4, returning [1,2,3,5].](figures/solution-two-pointer-gap.svg)
