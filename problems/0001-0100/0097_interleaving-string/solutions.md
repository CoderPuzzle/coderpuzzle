...
![For s1 = "aabcc", s2 = "dbbca", s3 = "aadbbcbcac", the 6x6 dp table fills row by row with true cells tracing the accepting reaches from (0, 0) to dp[5][5] = true, including a fork cell fed by both its up and left neighbors.](figures/solution-interleave-dp-table.svg)
