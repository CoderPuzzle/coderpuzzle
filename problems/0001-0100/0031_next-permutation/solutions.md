...
![On nums = [1, 2, 3] the right-to-left scan names 2 the pivot and 3 its successor, the swap gives [1, 3, 2], and the one-element suffix reversal changes nothing — the next permutation is [1, 3, 2].](figures/solution-pivot-swap-suffix-reverse.svg)
