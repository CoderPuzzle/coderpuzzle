...
![On nums = [2,5,6,0,0,1,2] with target 3, each window keeps the half proven sorted — right, then left — until lo = mid = hi reads 2, 2, 2 and one lo-shrink empties the window, returning false.](figures/solution-window-shrink-tie.svg)
