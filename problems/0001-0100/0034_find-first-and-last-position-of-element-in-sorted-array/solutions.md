...
![On [5,7,7,8,8,10] with target 8: the first bisection contracts to index 3 — the first value ≥ 8 — and the second to 5, the first value ≥ 9, so the run of 8s is exactly [3, 4].](figures/solution-two-bisections.svg)
