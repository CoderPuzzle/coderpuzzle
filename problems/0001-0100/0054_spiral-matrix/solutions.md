...
![On matrix [[1,2,3],[4,5,6],[7,8,9]], the four boundary runs emit 1 2 3, then 6 9, then 8 7, then 4, and after every boundary steps inward the centre takes 5, giving [1,2,3,6,9,8,7,4,5].](figures/solution-boundary-ring-walk.svg)
