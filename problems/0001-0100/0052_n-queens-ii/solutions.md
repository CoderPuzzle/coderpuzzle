...
![On the n = 4 board, the row-by-row walk with column, r−c and r+c marks prunes every attacked square in row 1, completes [1,3,0,2] at count 1, and its mirror branch [2,0,3,1] lifts the count to 2.](figures/solution-backtrack-marks-walk.svg)
