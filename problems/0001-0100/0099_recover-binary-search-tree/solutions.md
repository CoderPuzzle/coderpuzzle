...
![For root = [1, 3, null, null, 2], the inorder 3, 2, 1 shows descents 3 > 2 and 2 > 1 whose endpoints 3 and 1 trade values, restoring the ascending 1, 2, 3 and the tree [3, 1, null, null, 2].](figures/solution-inorder-descent-swap.svg)
