...
![Filling n = 3, the boundary walk writes ring 1 as 1 2 3, then 4 5, then 6 7, then 8, and ring 2's single top-row run puts 9 in the centre, producing [[1,2,3],[8,9,4],[7,6,5]].](figures/solution-ring-fill-runs.svg)
