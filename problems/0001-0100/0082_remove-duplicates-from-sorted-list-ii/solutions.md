...
![On head [1,2,3,3,4,4,5], tail holds the kept prefix [1,2] while the whole run of 3s is unlinked node by node until the differing 4 appears.](figures/solution-tail-run-unlink.svg)
