...
![Walking height = [1,8,6,2,5,4,8,3,7] with two pointers: each step measures the width times the shorter wall and retires that wall, and the pair (1, 8) measures the best area 7 x 7 = 49.](figures/solution-two-pointer-walk.svg)
