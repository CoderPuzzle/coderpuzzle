...
![Mid-scan on nums = [1,1,1,2,2,3], the third 1 fails nums[read] != nums[write-2] (1 == nums[0]) so write holds while read steps over it, and the kept prefix ends at [1,1,2,2,3] with k = 5.](figures/solution-read-write-compaction.svg)
