...
![Walking s = "PAYPALISHIRING" with numRows = 3 fills the three row buffers PAHN, APLSIIG and YIR along the pen's zigzag path; read top to bottom they give PAHNAPLSIIGYIR.](figures/solution-row-buffers.svg)
