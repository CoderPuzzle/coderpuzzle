...
![Example 2's tree with each node's required interval: 5 sits in (−∞, +∞), 1 in (−∞, 5), but 4 must sit in (5, +∞) and fails — the walk answers false without ever reaching 3 or 6.](figures/solution-bounded-dfs-intervals.svg)
