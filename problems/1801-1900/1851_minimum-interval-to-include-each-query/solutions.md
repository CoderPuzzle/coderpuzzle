...
![Offline sweep for intervals [[1,4],[2,4],[3,6],[4,4]] and queries [2,3,4,5]: each query reads the size-keyed min-heap's surviving top, giving 3, 3, 1, and — after the expired tops pop at q = 5 — 4.](figures/solution-interval-heap-sweep.svg)
