...
![On n = 100 the first egg drops at floors 9, 22, 34 and onward with the gaps shrinking 12, 11, 10, so each gap after the first still totals exactly 14 moves and the smallest m with m(m+1)/2 >= 100 is 14.](figures/solution-triangular-drop-schedule.svg)
