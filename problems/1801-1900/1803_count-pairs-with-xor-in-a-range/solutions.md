...
![With nums = [1,4,2,7] and k = 6, the query for x = 7 banks value 4's
whole subtree (7^4 = 3) and value 2's (7^2 = 5) at the two 1-bits, then
counts value 1 exactly (7^1 = 6) — and f(high) − f(low−1) = 6 over the
stream.](figures/solution-xor-trie-walk.svg)
