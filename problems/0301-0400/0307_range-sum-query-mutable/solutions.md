...
![For `nums = [1, 3, 5]` the blocks hold `tree[1] = 1`, `tree[2] = 1 + 3 = 4` and
`tree[3] = 5`, so `prefix(3)` collects two disjoint blocks, `5 + 4 = 9`, as `i`
walks `3 -> 2 -> 0`.](figures/solution-fenwick-lowbit-blocks.svg)
