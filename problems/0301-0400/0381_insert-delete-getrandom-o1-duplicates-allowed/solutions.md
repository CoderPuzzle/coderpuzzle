...
![The example's remove(1) on values = [1, 1, 2] with 1 → {0, 1}, 2 → {2}: the leftmost index 0 goes, the last element 2 moves into slot 0, and both sets repair to 1 → {1}, 2 → {0}, leaving a = [2, 1].](figures/solution-remove-leftmost-swap.svg)
