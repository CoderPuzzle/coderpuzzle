...
![On `nums = [1, 3]`, `n = 6`: consuming 1 covers [1, 2), the patch 2 doubles coverage to [1, 4), and consuming 3 reaches [1, 7) past n, so one patch suffices.](figures/solution-greedy-coverage-doubling.svg)
