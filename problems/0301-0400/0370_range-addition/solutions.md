...
![On length = 5 with updates [[1,3,2],[2,4,3],[0,2,-2]], each update writes
its two markers into the difference array and one prefix sweep accumulates
them into [-2, 0, 3, 5, 3].](figures/solution-diff-array-markers-sweep.svg)
