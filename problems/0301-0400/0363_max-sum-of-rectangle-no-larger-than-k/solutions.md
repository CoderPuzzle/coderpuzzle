...
![Row pair 0-1 collapses `[[1, 0, 1], [0, -2, 3]]` to `col_sum` [1, -2, 4]; the sweep over prefixes 1, -1, 3 queries the sorted prefix list for the smallest entry at least `prefix - k`, and 3 - 1 = 2 is the best rectangle sum.](figures/solution-row-pair-prefix-sweep.svg)
