...
![Fisher-Yates on nums = [1, 2, 3]: i = 2 draws j = 1 from [0, 2] and i = 1 draws j = 0 from [0, 1], each step fixing slot i for good and ending at [3, 1, 2], one of the 3! = 6 equally likely orderings.](figures/solution-fisher-yates-steps.svg)
