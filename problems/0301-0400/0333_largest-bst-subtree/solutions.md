...
![In `[10,5,15,1,8,null,7]` the post-order reports 1, 8, 5 (size 3), 7, 15 bubble up until 15's min of 7 makes the root fail the check `10 < 7`, leaving subtree `[5,1,8]` and its size 3 as the answer.](figures/solution-post-order-reports.svg)
