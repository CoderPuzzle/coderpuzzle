...
![On nums = [1,2,1] the buckets evolve to cnt[1] = 4 and sm[1] = 9 while cnt[2] = 2 and sm[2] = 5 hold, as the running total accrues 1 + 5 + 8 = 14.](figures/solution-value-buckets-accrual.svg)
