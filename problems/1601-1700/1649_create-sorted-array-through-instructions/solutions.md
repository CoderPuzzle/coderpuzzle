...
![On instructions = [1, 5, 6, 2], after inserting 1, 5, 6 the tree reads 1, 1, 0, 1, 1, 2, and inserting 2 queries cells 1 and 2 for the cost min(1, 2) = 1.](figures/solution-fenwick-insert-cost.svg)
