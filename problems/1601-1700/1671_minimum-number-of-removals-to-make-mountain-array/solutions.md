...
![On nums = [2,1,1,5,6,2,3,1], the per-index lis and lds tables pair
3 + 3 - 1 = 5 kept elements at the peak 6, and the other 3 entries are the
removals: indices 0, 1, 5 go, leaving [1,5,6,3,1].](figures/solution-bitonic-tables.svg)
