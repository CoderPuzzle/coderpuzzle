...
![On inventory = [2, 5] with orders = 4, the greedy sells the 5 + 4 + 3 band off the tall pile plus the lone 2 off the short one, earning 14.](figures/solution-band-selling.svg)
