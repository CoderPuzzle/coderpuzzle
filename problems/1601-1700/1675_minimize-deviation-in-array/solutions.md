...
![Halving the maximum of normalized [4,2,10,20,6] step by step, the deviation reads 18, 8, 8, 4 and finally 3, stopping because the maximum 5 is odd.](figures/solution-max-heap-halving-steps.svg)
