...
![On example 1's 3-node graph, the sweep answers query [0, 1, 2] before any union (find(0) ≠ find(1), false) and query [0, 2, 5] after edges of weight 2 and 4 fuse every node into root 2's component (true).](figures/solution-union-find-limit-sweep.svg)
