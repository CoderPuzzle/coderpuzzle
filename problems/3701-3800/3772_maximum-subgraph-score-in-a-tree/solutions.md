...
![On Example 2's tree the down sweep keeps down = 3 at node 1, 2 at node 3, and 1 at node 4 while pruning the −1 branches at 0 and 2, and the up sweep hands child 0 the parent-side piece 1 + 2 + 0 = 3, so answers are [2, 3, 2, 3, 3].](figures/solution-reroot-down-up.svg)
