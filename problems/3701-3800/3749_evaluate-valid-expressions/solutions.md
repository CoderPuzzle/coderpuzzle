...
![For the expression div(mul(4,sub(9,5)),add(1,1)) of Example 3, the parse tree evaluates bottom-up: sub returns 4, mul returns 16, add returns 2, and the root division returns 8.](figures/solution-parse-tree-bottom-up.svg)
