...
![On stations = [1,2,4,5,0] with r = 1 and k = 2, the sweep at target 5 finds only city 0 short (3 < 5), builds both stations at city 1, and retires them entering city 3, so used = 2 closes the check.](figures/solution-greedy-sweep-target-5.svg)
