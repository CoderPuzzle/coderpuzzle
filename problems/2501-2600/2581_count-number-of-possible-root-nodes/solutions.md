...
![On example 1's tree, rooting at 0 makes guesses (1,3), (0,1) and (2,4) correct — count 3; moving the root across edge 0–1 to node 1 flips only that edge, losing (0,1) and gaining (1,0), so the count stays 3.](figures/solution-reroot-guess-flip.svg)
