...
![After the flip query [1, 1, 1] the covered leaf [1, 1] inverts its sum to 1 − 0 = 1 and sets its flag, the root reports 3 ones, and the type-2 query adds 1 × 3 for a total of 3.](figures/solution-lazy-flip-tree.svg)
