...
![On the 5 x 7 example grid the multi-source BFS stamps every cell with its fire-arrival minute, and the walk that waits 3 minutes — leaving at t = 4 down column 0 and along row 4 — stays strictly ahead until it reaches the safehouse at t = 13 <= 14.](figures/solution-fire-bfs-minutes.svg)
