...
![For strength = [1,3,1,2], the monotonic-stack sweep shades each wizard's unique-minimum span (prev[i], nxt[i]) and folds strength[i] times that span's subarray sums into contributions of 5, 9, 26, and 4 — a total of 44.](figures/solution-unique-min-spans.svg)
