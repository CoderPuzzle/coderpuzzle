...
![With nums = [4,2,1,4,3,4,5,8,15] and k = 3, best[] fills down the value axis one window query per element, and the largest entry ever written is best[8] = 5, the length of [1,3,4,5,8].](figures/solution-window-max-best-fill.svg)
