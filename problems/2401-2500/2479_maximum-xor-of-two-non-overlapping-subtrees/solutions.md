...
![When Example 1's DFS enters node 2 (sum 8), the trie of finished subtrees holds 6, 2 and 16; the greedy query pairs 8 with 16 for 8 XOR 16 = 24.](figures/solution-entry-trie-snapshot.svg)
