...
![On Example 1's robots [0, 4, 6] and factories [[2, 2], [6, 2]], the sorted number line splits into contiguous blocks — the factory at 2 takes robots 0 and 4, the factory at 6 takes robot 6 — and the dp fills to dp[3] = 2 + 2 + 0 = 4.](figures/solution-contiguous-blocks-dp.svg)
