...
![On nums = [2, 4, 0, 9, 6], the two stacks evolve per arrival — 9 answers index 0 from the second stack and graduates indices 1 and 2 into it, then 6 answers both — leaving [9, 6, 6, -1, -1].](figures/solution-dual-stack-trace.svg)
