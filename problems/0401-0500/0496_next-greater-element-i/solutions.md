...
![nums2 = [1,3,4,2] drained through the non-increasing stack: 3 pops 1 (so 1 maps to 3), 4 pops 3 and finds nothing after it, leaving the map's -1 entries answered by one lookup each.](figures/solution-monotonic-stack-map.svg)
