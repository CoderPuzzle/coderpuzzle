...
![Folding 10, 0001, 111001, 1, 0 into the 6x4 dp table with both budget axes counting down tints each fold's changed cells and ends at dp[5][3] = 4.](figures/solution-two-axis-dp-folds.svg)
