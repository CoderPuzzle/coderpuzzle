...
![On nums = [1, 5, 2] the difference table fills by increasing length, giving dp[0][1] = 4 and dp[1][2] = 3, so dp[0][2] = max(1 - 3, 2 - 4) = -2 < 0 and player 1 loses.](figures/solution-interval-dp-difference.svg)
