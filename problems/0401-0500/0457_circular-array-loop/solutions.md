...
![On nums = [2, -1, 1, 2, 2], the walk from index 0 stamps 0, 2, 3 in the state array and its third hop lands back on stamped 0, closing the same-direction cycle 0 → 2 → 3 → 0.](figures/solution-walk-stamps-cycle.svg)
