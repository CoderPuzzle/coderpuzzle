...
![On words = ["area", "lead", "wall", "lady", "ball"], the half-built square ball/area/lead makes column 3 force the prefix 'lad', and the prefix map's bucket for 'lad' holds only lady — the single candidate for row 3.](figures/solution-prefix-bucket-candidate.svg)
