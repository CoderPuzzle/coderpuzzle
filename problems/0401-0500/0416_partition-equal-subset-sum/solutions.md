...
![On nums = [1,5,11,5] with target 11, the mask grows {0,1} → {0,1,5,6} → {0,1,5,6,11} under mask | (mask << v) — bit 11 sets as soon as 11 is read, before the last 5 is ever used.](figures/solution-bitmask-shift-or.svg)
