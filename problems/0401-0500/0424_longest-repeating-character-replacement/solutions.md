...
![The sweep over s = AABABBA with k = 1: window AABA holds length 4 − max freq 3 = 1 replacement, the best seen, and extending to the second B breaks the budget at 5 − 3 = 2 until the left edge shrinks it back to A B A B.](figures/solution-window-budget.svg)
