...
![The scan of 1432219 with k = 3: each arriving smaller digit pops the larger kept digit — 4, then 3, then the second 2 — and the non-decreasing stack ends as 1219 with the removals exactly spent.](figures/solution-monotonic-pop.svg)
