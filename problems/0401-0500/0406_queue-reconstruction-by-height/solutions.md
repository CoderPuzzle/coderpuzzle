...
![Sorting [[7,0],[4,4],[7,1],[5,0],[6,1],[5,2]] tallest-first and inserting each person at index k grows the queue row by row into [[5,0],[7,0],[5,2],[6,1],[4,4],[7,1]] without disturbing earlier placements.](figures/solution-tallest-first-inserts.svg)
