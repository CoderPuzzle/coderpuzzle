...
![The robot's spiral DFS on the example grid: cells 1–11 cleaned in visit order, with the dead end at (0,0) backing out to (0,1) via two right turns before the sweep continues.](figures/solution-spiral-dfs-backtrack.svg)
