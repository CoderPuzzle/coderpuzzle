...
![On nums = [2, 4, 6, 8, 10], the difference-keyed counts fill row by row — dp[4] ends at {2: 4, 4: 2, 6: 1, 8: 1} — and each pair j < i adds dp[j][d] to the running total, which reaches 7 at i = 4, d = 2.](figures/solution-difference-keyed-counts.svg)
