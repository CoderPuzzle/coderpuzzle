...
![On nums = [1,2,4,5], k = 3, each column lists the distinct ORs of the subarrays ending at r — {1}, {2,3}, {4,6,7}, {5,7} — with |OR - 3| under every value; the exact hit 3 from nums[0..1] gives the answer 0.](figures/solution-suffix-or-sets.svg)
