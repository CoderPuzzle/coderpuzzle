...
![In the 16-vertex 4-cube, BFS seeded at 1001, 1100, 1011 floods every vertex, and the complement 0110 of nums[0] = 1001 ends at dist 2, so answer[0] = 4 - 2 = 2.](figures/solution-hypercube-multisource-bfs.svg)
